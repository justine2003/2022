...
public class EliminarUsuario 
{
 public boolean Eliminar(String Nombre)
 {
     try 
     {
         ...
         int respuesta = JOptionPane.showConfirmDialog(null,"Realmente quieres eliminar este usuario","Eliminar usuario",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
